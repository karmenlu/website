            ...
            <section id="about">
                ...
                <div className="content row align-self-center">
                    <div className="sectionBodyText">
                        ...
                        to collaborate with peers, to ask questions, and to learn from everyone around me. Since
                        entering
                        college as a first generation student with no prior programming experience, I have been growing
                        as
                        an engineer through coursework, involvement in student organizations, and technical
                        work experiences. Through technical internships in frontend, backend, and infrastructure
                        roles, I learned about the software industry and about how to work in large codebases.
                        ...
                        software engineering/development. In particular, I am interested in the health and wellness
                        technology.
                        <br/><br/>
